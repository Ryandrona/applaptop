...
function ImageGallary() {
  ...
  return (
    <div className="container">
      <h4 class="text-center text-success  ml-4 mb-4 mt-4">Mục Hình Ảnh</h4>
      <div className="row">
        <div className="col-sm-3 p-2 bg-gray">
         <div className="box mr-4" style={{border:"1px solid #b7b7b7",backgroundColor:"#rgb(253 253 253);"}}>
         <h5 class="text-center  ml-4 mb-3 mt-3">Thêm Hình Ảnh</h5>
          <table className="">
           <tr>
            <td>
              <div class="form-group ml-3">
                <input type="text" name="name" className="mb-4"onChange={(e) => setName(e.target.value)} placeholder="Tên thư mục hình ảnh"/>
              </div>
            </td>
           </tr>
           ...
           <tr>
            <td>
             <div class="form-group">
              <textarea type="text" name="desc" className="mb-4"  rows="3" cols="23" onChange={(e) => setDesc(e.target.value)} placeholder="Mô tả hình ảnh" />
             </div>
            </td>
           </tr>
